        ...
        return (
          <div className="combined-wrapper">
              <div className="combined-reload">
                  <Link  className="goToAdmin"  to="/admin">Go to admin panel</Link>
              </div>
              <div>
                  <Button className="Btn-refresh" icon="reload" type="reload" onClick={this.onClick} />
